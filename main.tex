...
The \textit{tugturn.py} module is designed as a highly cohesive command-line interface (CLI) driven tool. It ingests 3D coordinate time-series (typically derived from MediaPipe and processed via the \textit{vail\'{a}} framework) and executes a multi-stage deterministic pipeline. 
